...
public:
  ...
  bool isRecoverablePath(taco::IndexVar indexVar, std::set<taco::IndexVar> defined, std::set<IndexVar> consumers) const;

  bool isRecoverablePathHelper(taco::IndexVar indexVar, std::set<taco::IndexVar> defined, std::set<IndexVar> consumers) const; 
