...
TEST(provGraph, isRecoverableSinglePrecompute){
  ...
  assert(provGraph.isConsumer(i1));
  assert(provGraph.isConsumer(iw));
  ...
  assert(provGraph.isRecoverable(i, defined));
  ...
  assert(provGraph.isRecoverable(i, defined2));
  ...
  assert(provGraph.isRecoverable(i, defined3));
